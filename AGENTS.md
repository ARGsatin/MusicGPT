...
- As of 2026-08-04, this `aurora-ui` worktree uses Alibaba Cloud `qwen3.5-omni-plus-realtime` WebRTC instead of the retired Edge TTS/OpenAI Realtime pipelines, while preserving the Aurora Deck UI and its queue/audio controls.
